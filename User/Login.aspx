                          ...
                          <div class="row">
                              ...
                              <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlLoginType" ErrorMessage="UserType is required" 
                            ...
                            <div class="form-group mt-3">
                                ...
                                <asp:Button runat="server" ID="btnLogin" Text="Login" CssClass="button button-contactForm boxed-btn mr-4" 
