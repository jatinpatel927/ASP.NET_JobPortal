...
public partial class Admin_viewResume : System.Web.UI.Page
{
    ...
    private void ShowAppliedJob()
    {
        ...
        query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No],aj.AppliedJobId,j.CompanyName,aj.JobId,
                 j.Title,u.Mobile,u.Name,u.Email,u.Resume 
                from AppliedJobs aj inner join [User] u on aj.UserId = u.UserId inner join Jobs j on aj.JobId = j.JobId";
